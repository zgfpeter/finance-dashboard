          ...
          <div className="flex relative">
            <div className="flex flex-col p-3 gap-3 relative">
              ...
              <input
                ...
                name="date"
                id="date"
                className="border border-(--secondary-blue) rounded p-2  focus:outline-none focus:border-cyan-500 h-10  w-40"
              />
            </div>
            ...
            <div className="flex flex-col p-3 gap-3 relative">
              ...
              <select
                ...
                required
                className="border border-(--secondary-blue) px-2 rounded h-10 flex min-w-40"
              >
